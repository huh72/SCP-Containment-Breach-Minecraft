...
execute if entity @s[tag=flying] run scoreboard players add .temp scp372.searchTimer 1
...
execute if score .temp scp372.searchTimer = .max scp372.searchTimer run function scp372:disappear