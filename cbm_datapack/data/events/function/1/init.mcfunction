...
execute at @n[type=marker,tag=event1_spawn049] run playsound cb:scp049.event1spawn ambient @a[distance=..32] ~ ~ ~ 1 1 1
execute at @n[type=marker,tag=event1_spawn049] run playsound cb:scp049.event1_2 ambient @a[distance=..32] ~ ~ ~ 1.25 1 1
kill @e[type=marker,tag=event1_spawn049]

execute as @e[tag=event1_door] at @s if entity @s[tag=closed] run playsound cb:scp079.horror ambient @a[distance=..24] ~ ~ ~ 0.85 1 1
