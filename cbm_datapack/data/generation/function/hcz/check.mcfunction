...
#hcz-ez checkpoint
$execute positioned ~-4 ~1 ~ if score $(pos) hsq matches 12 run place template lcz:hczcheck
$execute positioned ~-4 ~1 ~ if score $(pos) hsq matches 17 run place template lcz:hczcheck
