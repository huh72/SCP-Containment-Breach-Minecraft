# execute as @n[tag=door_marker_hcz] if score @s door_interact_cd matches 0 as @n[tag=aj.door0.root] run function animated_java:door0/animations/openclosetoggle/play
