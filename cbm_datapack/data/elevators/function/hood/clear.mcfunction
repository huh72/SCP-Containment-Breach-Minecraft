...
execute if entity @a[tag=location.939storage] at @n[tag=939.spawnpoint1] run function scp939:89/spawn
execute if entity @a[tag=location.939storage] at @n[tag=939.spawnpoint2] run function scp939:96/spawn
