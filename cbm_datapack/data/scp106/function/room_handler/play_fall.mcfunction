...
tag @s[tag=!fall_into_shrinkhole] add caughtInLcz
tag @s[tag=!fall_into_shrinkhole] add hitby106
execute if entity @s[tag=!fall_into_shrinkhole] run function scp106:pd/enter
