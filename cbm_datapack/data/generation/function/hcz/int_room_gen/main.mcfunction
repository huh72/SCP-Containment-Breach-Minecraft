...
### DEADENDS
# scp 035
execute as @e[tag=dd,tag=hcz,sort=random,limit=1] at @s run function generation:hcz/int_room_gen/deadends/106 {"room":"hcz:dd_035_"}
# scp 008
execute as @e[tag=dd,tag=hcz,sort=random,limit=1] at @s run function generation:hcz/int_room_gen/deadends/106 {"room":"hcz:dd_008_"}
# scp 079
execute as @e[tag=dd,tag=hcz,sort=random,limit=1] at @s run function generation:hcz/int_room_gen/deadends/106 {"room":"hcz:dd_079_"}
# scp 106
