...
execute if entity @s[tag=card5] if score chance scp914 matches 0..9 run return run function spawn:drop/card_omni
execute if entity @s[tag=card5] if score chance scp914 matches 10..99 run function spawn:drop/playingcard
