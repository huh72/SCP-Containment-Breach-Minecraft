# setblock ~ ~12 ~ minecraft:oak_sign[rotation=1]{front_text:{messages:['[{"text":"13 (0)}]','[{"text":"13 (0)"}]','[{"text":"13 (0)"}]','[{"text":"13 (0)"}]']}}
...
#g elevator
execute at @n[tag=elevatorSpawnpoint] run place template lcz:elevator ~ ~-1 ~-4 none
