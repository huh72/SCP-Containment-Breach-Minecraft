summon wandering_trader ~ ~ ~ {Tags:['scp939_96','scp939','new'],Invulnerable:1b,Silent:1b,PersistenceRequired:1b}
summon marker ~ ~1 ~ {Tags:['marker939_96','marker939']}
...
effect give @n[tag=scp939_96] invisibility infinite 1 true
