attribute @s minecraft:generic.movement_speed modifier add 1488-0-0-1-9 -1 add_value
attribute @s minecraft:generic.movement_speed modifier remove 1488-0-0-2-0
