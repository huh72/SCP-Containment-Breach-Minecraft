$summon armor_stand ~ ~ ~ {Tags:['drop','new','radio'],Invisible:1b,Silent:1b,Invulnerable:1b,NoBasePlate:1b}
item replace entity @n[tag=new] armor.head with paper[item_model="cb:radio"]
