#spawn grenade & sound
summon armor_stand ^ ^ ^1 {Tags:['grenade','he','new'],NoAI:1b,NoGravity:1b,Silent:1b,Invisible:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:paper,components:{custom_model_data:42}}]}
...
#timer
scoreboard players operation @e[tag=new] grenade_timer = max grenade_timer
...
execute as @e[tag=grenade] at @s anchored eyes run function grenades:slow_cast/move
tag @e remove new