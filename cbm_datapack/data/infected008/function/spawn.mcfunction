...
$summon zombie ~ ~ ~ {Tags:['infected008', 'new', 'tesla_trigger', '$(state)'],Silent:1b,Invulnerable:1b,Armor_items:[{},{},{},{id:"minecraft:air",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:protection":1}}}}],PersistenceRequired:true}
