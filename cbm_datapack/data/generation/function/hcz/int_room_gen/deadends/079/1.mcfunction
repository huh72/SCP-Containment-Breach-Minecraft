setblock ~ ~12 ~ minecraft:oak_sign[rotation=1]{front_text:{messages:['[{"text":"13! (1)}]','[{"text":"14 (1)"}]','[{"text":"14 (1)"}]','[{"text":"14 (1)"}]']}}

#g 079 model spawn
execute at @n[tag=079.spawnpoint] run summon item_display ~ ~0.525 ~ {Tags:['079face','1'],item:{id:"paper",components:{item_model:"cb:scp/079_face"}},transformation:{translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,1.25f,0f,1f],scale:[1f,1f,1f]}}
