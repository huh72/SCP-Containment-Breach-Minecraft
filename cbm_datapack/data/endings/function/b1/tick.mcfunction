...
execute if score .alphawarhead.time e = .alphawarhead.time.siren.stop e run stopsound @a ambient cb:b1.siren
execute if score .alphawarhead.time e = .alphawarhead.time.explosion.first e at @a run playsound cb:b1.nuke_explosion_far ambient @a ~ ~ ~ 100 1 1
execute if score .alphawarhead.time e = .alphawarhead.time.explosion.final e at @a run function endings:b1/warhead/explode