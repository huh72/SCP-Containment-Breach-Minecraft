...
execute unless score @s shader.motionblur.prev = @s shader.motionblur run function shader_control:effects/motionblur/helper with storage cb:shader
...
scoreboard players operation @s shader.motionblur.prev = @s shader.motionblur
