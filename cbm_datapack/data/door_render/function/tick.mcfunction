...
execute as @e[type=item_display,tag=door_marker,tag=dr.not_rendered,tag=!card] at @s if entity @a[distance=..19] run function doors:respawn_door
...
execute as @e[type=item_display,tag=door_marker,tag=dr.not_rendered,tag=card] at @s if entity @a[distance=..19] run function doors:respawn_door_card
...
execute as @e[type=item_display,tag=door_marker_hcz,tag=dr.not_rendered,tag=!card] at @s if entity @a[distance=..19] run function doors:respawn_door_hcz