...
execute if block ~ ~ ~ #minecraft:doors[facing=north] run function raycast:transforms/rotate_90
execute if block ~ ~ ~ #minecraft:doors[facing=west] run function raycast:transforms/rotate_180
execute if block ~ ~ ~ #minecraft:doors[facing=south] run function raycast:transforms/rotate_270
