...
#vars
scoreboard players operation @e[tag=new] tesla_idle = max* tesla_idle
scoreboard players operation @e[tag=new] tesla_shock_timer = max* tesla_shock_timer
scoreboard players set @e[tag=new] tesla_shock_cd 0
scoreboard players set @e[tag=new] activate_cd 0
scoreboard players set @e[tag=new] activating 0
