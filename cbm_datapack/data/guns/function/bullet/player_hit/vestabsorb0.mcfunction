...
#g damage player
execute if predicate guns:33 run scoreboard players remove @s health 1
execute if predicate guns:10 run scoreboard players add @s bleeding 1

#g blood particle
execute if predicate guns:33 run particle block{block_state:{Name:redstone_block}} ~ ~ ~ 0 0 0 0 3
