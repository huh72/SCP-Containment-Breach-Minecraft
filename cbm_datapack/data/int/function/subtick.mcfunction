...
#0
execute as @n[tag=i.0] at @s if score .timer i > .cd0.approach.time i if score .timer i < .cd.approach.stop.time i run function int:path/d/forward
#1
execute as @n[tag=i.1] at @s if score .timer i > .cd1.approach.time i if score .timer i < .cd.approach.stop.time i run function int:path/d/forward
execute if score .timer i = .cd.approach.stop.time i run function int:path/d/final
