say 13!
execute at @n[tag=008spawnpoint] rotated 0 0 run function animated_java:scp008/summon with storage aj:temp
...
execute at @n[type=marker, tag=doorsspawnpoint] positioned ~3 ~ ~ rotated 90 0 run function animated_java:singledoor0/summon with storage aj:temp
execute at @n[type=marker, tag=doorsspawnpoint] positioned ~3 ~ ~ as @e[tag=aj.singledoor0.root] run function animated_java:singledoor0/animations/openclosetoggle/set_frame {"frame":"0"}
