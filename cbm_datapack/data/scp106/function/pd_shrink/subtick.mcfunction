...
execute if score @s[tag=up] pd_shrink_scale < max pd_shrink_scale run function scp106:pd_shrink/sizeup with storage cb:pds
...
#summon
execute if score @s step_on_shrink = max step_on_shrink run function scp106:pd_shrink/summon106
