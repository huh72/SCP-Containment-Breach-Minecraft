...
tp @n[type=item_display, tag=aj.scp066.root] ~ ~ ~
data modify entity @n[type=item_display, tag=aj.scp066.root] Rotation[0] set from entity @s Rotation[0]
...
execute if score previousTick speedScp066 matches 0 if score @s speedScp066 matches 1 as @n[type=item_display, tag=aj.scp066.root] run function animated_java:scp066/animations/wallow/play

#play rolling animation - if previous tick was moving and now is idle
execute if score previousTick speedScp066 matches 1 if score @s speedScp066 matches 0 as @n[type=item_display, tag=aj.scp066.root] run function animated_java:scp066/animations/wallow/stop
