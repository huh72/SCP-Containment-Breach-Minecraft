...
execute if score rotation blooddrip matches 0 run summon armor_stand ~ ~ ~ {Tags:['blooddrip','new'],Invisible:1b,Invulnerable:1b,Silent:1b,ShowArms:1b,Marker:1b,attributes:[{id:"scale",base:1f}],Rotation:[0f,0f]}
execute if score rotation blooddrip matches 1 run summon armor_stand ~ ~0.03 ~ {Tags:['blooddrip','new'],Invisible:1b,Invulnerable:1b,Silent:1b,ShowArms:1b,Marker:1b,attributes:[{id:"scale",base:1f}],Rotation:[90f,0f]}
execute if score rotation blooddrip matches 2 run summon armor_stand ~ ~0.06 ~ {Tags:['blooddrip','new'],Invisible:1b,Invulnerable:1b,Silent:1b,ShowArms:1b,Marker:1b,attributes:[{id:"scale",base:1f}],Rotation:[180f,0f]}
execute if score rotation blooddrip matches 3 run summon armor_stand ~ ~0.09 ~ {Tags:['blooddrip','new'],Invisible:1b,Invulnerable:1b,Silent:1b,ShowArms:1b,Marker:1b,attributes:[{id:"scale",base:1f}],Rotation:[270f,0f]}
