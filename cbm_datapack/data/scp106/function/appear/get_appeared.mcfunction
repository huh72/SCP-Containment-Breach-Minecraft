...
execute as @n[tag=aj.scp106.root] run function animated_java:scp106/animations/idle/stop with storage aj:temp
execute as @n[tag=aj.scp106.root] run function animated_java:scp106/animations/walk/play with storage aj:temp