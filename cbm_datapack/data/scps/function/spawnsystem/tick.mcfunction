...
execute if score .timerCanBeIncreased 966spawnTimer matches 1 if score . 966spawnTimer < .request 966spawnTimer run scoreboard players add . 966spawnTimer 1
...
execute as @e[type=wandering_trader, tag=scp966] at @s as @p[tag=!dead] unless entity @s[distance=..48] run scoreboard players add .966 despawnTimer 1
...
execute if score . 966spawnTimer = .request 966spawnTimer if score .canSpawn 966spawnTimer matches 1 run function scps:spawnsystem/findwaypoint {"scp":"966"}
...
execute if score .966 despawnTimer = .despawnRequest despawnTimer run function scp966:despawn
...
execute as @e[type=wandering_trader, tag=scp966] at @s as @p[tag=!dead] unless entity @s[distance=..96] run function scp966:despawn