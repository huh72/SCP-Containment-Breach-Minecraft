#2 markers -> 1 marker
tag @s add duo
tag @n[tag=door_marker2,tag=!duo] add duo
...
#tags managment
tag @e[tag=duo,distance=..1] add door_marker_ez
tag @e[tag=duo,distance=..1] remove door_marker2
...
#next iteraction
function doors:unity_cycle_ez/cycle
