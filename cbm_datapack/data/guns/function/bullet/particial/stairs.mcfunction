...
execute if block ~ ~ ~ #minecraft:stairs[facing=north] run function guns:bullet/particial/transforms/rotate_90
execute if block ~ ~ ~ #minecraft:stairs[facing=west] run function guns:bullet/particial/transforms/rotate_180
execute if block ~ ~ ~ #minecraft:stairs[facing=south] run function guns:bullet/particial/transforms/rotate_270
...
execute if score #bool raycast matches 1 run function guns:bullet_hole/spawn_kill