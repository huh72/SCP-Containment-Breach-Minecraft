...
execute if score @s right_click_item matches 1.. as @n[tag=lever] if entity @s[tag=generator, tag=up, tag=!proceed] run function events:049/2
execute if score @s right_click_item matches 1.. as @n[tag=lever] if entity @s[tag=elevatorPowerFeed, tag=up, tag=!proceed] run function events:049/3
