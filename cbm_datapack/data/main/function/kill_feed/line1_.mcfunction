...
execute if entity @s[tag=d_1048a] run function main:kill_feed/line1 {"text":" overgrown with ears to death"}
execute if entity @s[tag=d_1499_1] run function main:kill_feed/line1 {"text":" was killed by an instance of SCP-1499-1"}
...
execute if entity @s[tag=d_fall] run function main:kill_feed/line1 {"text":" fell to his death"}
