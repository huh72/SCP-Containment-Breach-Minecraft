#radio
execute as @a[tag=dev,tag=radio] run item replace entity @s container.0 with carrot_on_a_stick[item_name="You can switch between the channels by pressing key 1 to 9",custom_data={channel:1}]
execute as @a[tag=dev,tag=radio] run item replace entity @s container.1 with carrot_on_a_stick[item_name="You can switch between the channels by pressing key 1 to 9",custom_data={channel:2}]
execute as @a[tag=dev,tag=radio] run item replace entity @s container.2 with carrot_on_a_stick[item_name="You can switch between the channels by pressing key 1 to 9",custom_data={channel:3}]
execute as @a[tag=dev,tag=radio] run item replace entity @s container.3 with carrot_on_a_stick[item_name="You can switch between the channels by pressing key 1 to 9",custom_data={channel:4}]
execute as @a[tag=dev,tag=radio] run item replace entity @s container.4 with carrot_on_a_stick[item_name="You can switch between the channels by pressing key 1 to 9",custom_data={channel:5}]
execute as @a[tag=dev,tag=radio] run item replace entity @s container.5 with carrot_on_a_stick[item_name="You can switch between the channels by pressing key 1 to 9",custom_data={channel:6}]
execute as @a[tag=dev,tag=radio] run item replace entity @s container.6 with carrot_on_a_stick[item_name="You can switch between the channels by pressing key 1 to 9",custom_data={channel:7}]
execute as @a[tag=dev,tag=radio] run item replace entity @s container.7 with carrot_on_a_stick[item_name="You can switch between the channels by pressing key 1 to 9",custom_data={channel:8}]
execute as @a[tag=dev,tag=radio] run item replace entity @s container.8 with carrot_on_a_stick[item_name="You can switch between the channels by pressing key 1 to 9",custom_data={channel:9}]

execute as @a[tag=!dev,tag=!radio,nbt=!{Inventory:[{Slot:0b,id:"minecraft:carrot_on_a_stick"}]}] run item replace entity @s container.0 with carrot_on_a_stick[item_name=""]
execute as @a[tag=!dev,tag=!radio,nbt=!{Inventory:[{Slot:1b,id:"minecraft:carrot_on_a_stick"}]}] run item replace entity @s container.1 with carrot_on_a_stick[item_name=""]
execute as @a[tag=!dev,tag=!radio,nbt=!{Inventory:[{Slot:2b,id:"minecraft:carrot_on_a_stick"}]}] run item replace entity @s container.2 with carrot_on_a_stick[item_name=""]
execute as @a[tag=!dev,tag=!radio,nbt=!{Inventory:[{Slot:3b,id:"minecraft:carrot_on_a_stick"}]}] run item replace entity @s container.3 with carrot_on_a_stick[item_name=""]
execute as @a[tag=!dev,tag=!radio,nbt=!{Inventory:[{Slot:4b,id:"minecraft:carrot_on_a_stick"}]}] run item replace entity @s container.4 with carrot_on_a_stick[item_name=""]
execute as @a[tag=!dev,tag=!radio,nbt=!{Inventory:[{Slot:5b,id:"minecraft:carrot_on_a_stick"}]}] run item replace entity @s container.5 with carrot_on_a_stick[item_name=""]
execute as @a[tag=!dev,tag=!radio,nbt=!{Inventory:[{Slot:6b,id:"minecraft:carrot_on_a_stick"}]}] run item replace entity @s container.6 with carrot_on_a_stick[item_name=""]
execute as @a[tag=!dev,tag=!radio,nbt=!{Inventory:[{Slot:7b,id:"minecraft:carrot_on_a_stick"}]}] run item replace entity @s container.7 with carrot_on_a_stick[item_name=""]
execute as @a[tag=!dev,tag=!radio,nbt=!{Inventory:[{Slot:8b,id:"minecraft:carrot_on_a_stick"}]}] run item replace entity @s container.8 with carrot_on_a_stick[item_name=""]
