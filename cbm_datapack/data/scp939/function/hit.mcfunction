execute at @n[tag=scp939] run tp @n[tag=scp939] ^ ^ ^0.25 facing entity @s
scoreboard players operation @n[tag=scp939] hit_cd = max* hit_cd
...
execute store result score scp939 damage run random value 12..24 cb:scp939damage
