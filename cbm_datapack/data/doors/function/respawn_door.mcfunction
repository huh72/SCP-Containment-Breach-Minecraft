...
execute if entity @s[tag=opened] as @n[tag=aj.door0.root] at @s run function animated_java:door0/animations/openclosetoggle/apply_frame {"frame":"34"}
execute if entity @s[tag=opened] as @n[tag=aj.door0.root] at @s run function animated_java:door0/animations/openclosetoggle/pause
