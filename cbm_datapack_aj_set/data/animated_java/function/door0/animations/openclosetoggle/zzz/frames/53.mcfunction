...
execute on vehicle unless entity @s[tag=aj.transforms_only] at @s run function animated_java:door0/animations/openclosetoggle/zzz/frames/53_root_commands