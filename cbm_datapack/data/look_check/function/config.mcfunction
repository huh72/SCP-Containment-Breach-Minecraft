...
#//g Y
data modify storage cb:lookcheck yRotMin0 set value 999
data modify storage cb:lookcheck yRotMax0 set value 999

data modify storage cb:lookcheck yRotMin1 set value 999
data modify storage cb:lookcheck yRotMax1 set value 999

data modify storage cb:lookcheck yRotMin2 set value 999
data modify storage cb:lookcheck yRotMax2 set value 999

data modify storage cb:lookcheck yRotMin3 set value 999
data modify storage cb:lookcheck yRotMax3 set value 999

data modify storage cb:lookcheck yRotMin4 set value 999
data modify storage cb:lookcheck yRotMax4 set value 999