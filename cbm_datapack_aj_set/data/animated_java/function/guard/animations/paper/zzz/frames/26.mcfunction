...
$data merge entity $(bone_body) {transformation: [-1f,0f,0f,0f,0f,0.9998f,-0.0209f,1.75f,0f,-0.0209f,-0.9998f,0f,0f,0f,0f,1f],start_interpolation: 0,interpolation_duration: 1}
