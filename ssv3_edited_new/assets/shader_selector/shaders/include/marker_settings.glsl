...
#define YELLOW_CHANNEL 13
#define FLICKER_CHANNEL 14
#define BURN_CHANNEL 15
...
#define LIST_MARKERS ADD_MARKER(GRAY_CHANNEL, 253, 251, 1, 0.4) ADD_MARKER(ROTATION_CHANNEL, 252, 251, 0, 0.0) ADD_MARKER(GREEN_CHANNEL, 251, 251, 1, 1) ADD_MARKER(BLUE_CHANNEL, 250, 251, 1, 1) ADD_MARKER(SHAKE_CHANNEL, 249, 251, 1, 0.0001) ADD_MARKER(BLUR_CHANNEL, 248, 251, 1, 0.5) ADD_MARKER(GOGGLES_CHANNEL, 247, 251, 1, 10) ADD_MARKER(BRIGHTNESS_CHANNEL, 246, 251, 0, 100) ADD_MARKER(SATURATION_CHANNEL, 245, 251, 1, 2) ADD_MARKER(TRAIL_CHANNEL, 244, 251, 1, 0.001) ADD_MARKER(GASMASK_CHANNEL, 243, 251, 1, 10) ADD_MARKER(ZOOM_CHANNEL, 242, 251, 1, 0.01) ADD_MARKER(YELLOW_CHANNEL, 241, 251, 1, 0.1) ADD_MARKER(FLICKER_CHANNEL, 240, 251, 1, 0.00001) ADD_MARKER(BURN_CHANNEL, 239, 251, 1, 0.5) ADD_MARKER(TEST_CHANNEL, 238, 251, 1, 0.001)
...
// YELLOW_CHANNEL              : particle minecraft:entity_effect{color:[0.996078431372549, 0.9450980392156862, 1.0, 0.984313725490196],scale:1f}
// FLICKER_CHANNEL             : particle minecraft:entity_effect{color:[0.996078431372549, 0.9411764705882353, 1.0, 0.984313725490196],scale:1f}
// FLICKER_STRENGTH_CHANNEL    : particle minecraft:entity_effect{color:[0.996078431372549, 0.9372549019607843, 1.0, 0.984313725490196],scale:1f}
// BURN_CHANNEL                : particle minecraft:entity_effect{color:[0.996078431372549, 0.9372549019607843, 1.0, 0.984313725490196],scale:1f} (239)
