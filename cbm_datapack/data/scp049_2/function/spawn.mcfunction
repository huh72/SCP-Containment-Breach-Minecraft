...
summon zombie ~ ~ ~ {Tags:['scp049_2','scp049_2g','tesla_trigger','new','hit', 'elevatorTarget'],Invulnerable:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:iron_helmet",Count:1}],PersistenceRequired:1b}
