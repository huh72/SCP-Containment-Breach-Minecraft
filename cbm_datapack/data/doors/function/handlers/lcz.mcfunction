...
execute if score @s[scores={door_right_click=1..,card_interact_cd=0}] access_level < @n[type=marker,tag=door_marker] access_level as @n[type=marker,tag=door_marker] at @s if entity @s[tag=card,scores={door_interact_cd=0}] positioned ~ ~1 ~ run function doors:card_denied

#scanner
execute if score @s[scores={door_right_click=1..}] scanner_value matches 1..2 as @n[type=marker, tag=door_marker] if entity @s[tag=sc, scores={door_interact_cd=0}, tag=closed] as @n[type=item_display, tag=aj.door0_sc.root] run function animated_java:door0_sc/animations/openclosetoggle/play
execute if score @s[scores={door_right_click=1..}] scanner_value matches 1..2 as @n[type=marker, tag=door_marker] if entity @s[tag=sc, scores={door_interact_cd=0}, tag=opened] as @n[type=item_display, tag=aj.door0_sc.root] run function animated_java:door0_sc/animations/openclosetoggle/resume
execute if score @s[scores={door_right_click=1.., card_interact_cd=0}] scanner_value matches 0 as @n[type=marker, tag=door_marker] at @s if entity @s[tag=sc, scores={door_interact_cd=0}] positioned ~ ~1 ~ run function doors:scanner_denied
...
execute if score @s[scores={door_right_click=1..,card_interact_cd=0}] access_level < @n[type=marker,tag=door_marker] access_level as @n[type=marker,tag=door_marker] at @s if entity @s[tag=checkpoint,scores={door_interact_cd=0}] positioned ~ ~1 ~ run function doors:card_denied
