...
###LCZ
execute as @e[type=item_display,tag=aj.door0.root] at @s if entity @n[tag=door_marker,tag=!dr.not_rendered,tag=!card,tag=!render_constantly] unless entity @a[distance=..20] run function animated_java:door0/remove/this
