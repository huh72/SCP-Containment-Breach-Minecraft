...
execute if score @s right_click_item matches 1.. as @n[tag=lever] if entity @s[tag=warhead, tag=up, tag=!proceed] run scoreboard players set .isWarheadEnabled e 0
execute if score @s right_click_item matches 1.. as @n[tag=lever] if entity @s[tag=warhead, tag=down, tag=!proceed] run scoreboard players set .isWarheadEnabled e 1
