...
#max
scoreboard players set max appear_timer 100

### disaper timer
scoreboard objectives add disappear_timer dummy
#max
scoreboard players set max disappear_timer 100

### hit 
scoreboard objectives add 106hit_cd dummy
scoreboard players set max 106hit_cd 20
...
scoreboard players set max hunting 800
...
scoreboard players set max laugh_cd 300
