...
scoreboard players set player_can_see_173* var 0
execute positioned ~-0.1 ~-0.1 ~-0.1 as @p[dx=0] positioned ~-0.7 ~-0.7 ~-0.7 if entity @p[dx=0] run scoreboard players set player_can_see_173* var 1
