...
function animated_java:ci/animations/pause_all
tag @s add aj.ci.animation.walk.playing
...
execute at @s run function animated_java:ci/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:ci/animations/walk/zzz/apply_frame {frame: $(to_frame)}
