summon armor_stand ~ ~ ~ {Tags:['drop','new','coin'],Invisible:1b,Silent:1b,Invulnerable:1b,NoBasePlate:1b}
item replace entity @n[tag=new] armor.head with paper[item_model="cb:coin"]
