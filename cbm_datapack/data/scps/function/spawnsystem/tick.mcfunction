...
execute if score .timerCanBeIncreased 049spawnTimer matches 1 if score . 049spawnTimer < .request 049spawnTimer run scoreboard players add . 049spawnTimer 1
...
#g spawn
execute if score . 106spawnTimer = .request 106spawnTimer if score .canSpawn 106spawnTimer matches 1 at @r[tag=!dead] run function scp106evolution:spawn
...
#g despawn
# execute if score * 106spawnTimer = .request 106spawnTimer if score .canSpawn 106spawnTimer matches 1 at @r run function scp106evolution:spawn
execute if score * 173spawnTimer = .despawnRequest despawnTimer run function scp173:despawn
# execute if score * 650spawnTimer = .request 650spawnTimer if score .canSpawn 650spawnTimer matches 1 run function scp650:spawn
execute if score * 457spawnTimer = .despawnRequest despawnTimer run function scp457:despawnall
execute if score * 049spawnTimer = .despawnRequest despawnTimer run function scp049:despawn
execute if score * 1048spawnTimer = .despawnRequest despawnTimer run function scp1048:despawn