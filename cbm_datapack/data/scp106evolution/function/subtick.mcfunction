...
execute if score 106 scp106state matches 1 if entity @s[tag=!a1.ending] run function scp106evolution:movement {"walkspeed":"0.215"}
execute if score 106 scp106state matches 2 if entity @s[tag=!a1.ending] run function scp106evolution:movement {"walkspeed":"0.1975"}

#defining targets
execute if score 106 scp106state matches 1..2 if entity @s[tag=!a1.ending] run function scp106evolution:definetarget/0
...
#laugh + breath sounds
execute if score 106 chasetheme_cd matches 0 if score 106 scp106state matches 1..2 if entity @s[tag=!a1.ending] run function scp106evolution:sounds/chasetheme
