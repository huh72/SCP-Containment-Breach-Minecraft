...
execute if entity @s[tag=13] run function generation:hcz/int_room_gen/deadends/079/1
execute if entity @s[tag=15] run function generation:hcz/int_room_gen/deadends/079/3
execute if entity @s[tag=16] run function generation:hcz/int_room_gen/deadends/079/2
