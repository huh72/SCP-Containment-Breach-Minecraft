execute if entity @s[tag=card1] run function spawn:drop/card1 {"state":"loot"}
execute if entity @s[tag=card2] run function spawn:drop/card2 {"state":"loot"}
execute if entity @s[tag=card3] run function spawn:drop/card3 {"state":"loot"}
execute if entity @s[tag=card4] run function spawn:drop/card4 {"state":"loot"}
execute if entity @s[tag=card5] run function spawn:drop/card5 {"state":"loot"}
execute if entity @s[tag=cardomni] run function spawn:drop/card_omni {"state":"loot"}
