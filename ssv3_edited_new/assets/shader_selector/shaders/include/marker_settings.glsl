...
#define LIST_MARKERS ADD_MARKER(GRAY_CHANNEL, 253, 251, 1, 0.4) ADD_MARKER(ROTATION_CHANNEL, 252, 251, 0, 0.0) ADD_MARKER(GREEN_CHANNEL, 251, 251, 1, 1) ADD_MARKER(BLUE_CHANNEL, 250, 251, 1, 1) ADD_MARKER(SHAKE_CHANNEL, 249, 251, 1, 0.0001) ADD_MARKER(BLUR_CHANNEL, 248, 251, 1, 0.5) ADD_MARKER(GOGGLES_CHANNEL, 247, 251, 1, 10) ADD_MARKER(BRIGHTNESS_CHANNEL, 246, 251, 1, 10) ADD_MARKER(SATURATION_CHANNEL, 245, 251, 1, 2) ADD_MARKER(TRAIL_CHANNEL, 244, 251, 1, 0.001) ADD_MARKER(GASMASK_CHANNEL, 243, 251, 1, 10) ADD_MARKER(ZOOM_CHANNEL, 242, 251, 1, 0.01)
