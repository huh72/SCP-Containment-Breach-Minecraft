...
execute if score .music.time e matches 1000 as @a[tag=b1.themechanged,tag=!secondThemePlayed] run function endings:b1/music2
...
execute if score .alphawarhead.time e = .alphawarhead.time.fail e at @p run function endings:b2/warhead/fail
execute if score .alphawarhead.time e = .alphawarhead.time.shot e as @a at @s run function endings:b2/warhead/shot