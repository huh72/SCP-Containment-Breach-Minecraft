...
tp @n[type=marker, tag=marker939_96] ~ ~1 ~
...
#func
execute as @n[tag=scp939_96,scores={phrase_cd=0}] at @s run function scp939:96/lure
...
execute as @p[tag=!dead,scores={spot_level=1..}] at @n[tag=marker939_96] positioned ~ ~1 ~ facing entity @s eyes run function scp939:raycast/main
...
###spot func
execute as @s[tag=chasing] run function scp939:96/unspot
execute as @s[tag=!chasing] at @s if entity @p[scores={spot_level=1},distance=..20] run function scp939:96/spot {"level":"1"}
execute as @s[tag=!chasing] at @s if entity @p[scores={spot_level=2},distance=..10] run function scp939:96/spot {"level":"2"}
execute as @s[tag=!chasing] at @s if entity @p[scores={spot_level=3}] run function scp939:96/spot {"level":"3"}
