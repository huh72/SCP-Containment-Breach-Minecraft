...
execute if block ~ ~ ~ #minecraft:slabs[type=double] run function guns:bullet_hole/spawn_kill
## if bottom slab, stop raycast if inside bottom part
execute if score .type raycast matches 1 if score .y raycast matches ..55 run function guns:bullet_hole/spawn_kill
## if top slab, stop raycast if inside top part
execute if score .type raycast matches 0 if score .y raycast matches 45.. run function guns:bullet_hole/spawn_kill