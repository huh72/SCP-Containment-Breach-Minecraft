...
execute if score @s aj.idle.frame matches -1 run function animated_java:scp1499_1/animations/idle/zzz/function_keyframe_loop_patch
data remove storage animated_java:temp args
execute store result storage animated_java:temp args.frame int 1 run scoreboard players get @s aj.idle.frame
function animated_java:scp1499_1/animations/idle/zzz/apply_frame with storage animated_java:temp args
